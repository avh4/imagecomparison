...
public class ImageComparisonMatchersEnclosedTest {
    ...
    public static void tearDown() {
        new File("ImageComparisonMatchersEnclosedTest.Inner.whenApprovalImageDoesNotExist_isApproved_doesNotMatch.png")
                .delete();
    }

    public static class Inner {
        @Test
        public void whenApprovalImageDoesNotExist_isApproved_doesNotMatch() throws Exception {
