...
public class UnrenderableExceptionTest {
    ...
    @Test
    public void getMessage_shouldIncludeListOfTriedRenderers() throws Exception {
        assertThat(subject.getMessage(), containsString("net.avh4.util.imagecomparison.UnrenderableExceptionTest$Renderer1"));
        assertThat(subject.getMessage(), containsString("net.avh4.util.imagecomparison.UnrenderableExceptionTest$Renderer2"));
    }
