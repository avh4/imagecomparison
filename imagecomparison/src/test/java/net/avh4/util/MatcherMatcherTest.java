...
import static net.avh4.util.MatcherMatcher.getDescription;
import static net.avh4.util.MatcherMatcher.getMismatchDescription;
...
public class MatcherMatcherTest {
    ...
    public static class doesNotMatch {
        ...
        @Test
        public void withAMatcherThatDoesMatch_shouldNotMatch() throws Exception {
    ...
    public static class doesNotMatch_withDescription {
        ...
        @Before
        public void setUp() throws Exception {
            matcherMatcher = MatcherMatcher.doesNotMatch("Expected").withDescription("was an object described by this custom mismatch description");
        }

        @Test
        public void withAMatcherThatGivesTheWrongMismatchDescription_shouldNotMatch() throws Exception {
            final Matcher<String> testMatcher = is("Actual");
            assertThat(matcherMatcher.matches(testMatcher), is(false));
            assertThat(getMismatchDescription(matcherMatcher, testMatcher),
        ...
        @Test
        public void withAMatcherThatGivesTheCorrectMismatchDescription_shouldMatch() throws Exception {
            final Matcher<String> testMatcher = new IsEqual<String>("Actual") {
                @Override
                public void describeMismatch(Object item, Description description) {
                    description.appendText("was an object described by this custom mismatch description");
                }
            };
            assertThat(matcherMatcher.matches(testMatcher), is(true));
        }
